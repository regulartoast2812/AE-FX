...
const FX_CONSOLE_COMMANDS = [
  { type: "command", name: "Open Quick Controls", category: "Native", shortcut: "Ctrl+Space", action: launchNativeQuickControls },
  { type: "command", name: "Trim In to Playhead", category: "Shortcut", shortcut: "Q", action: () => runBundledShortcut('Trim In to playhead.jsxbin') },
  { type: "command", name: "Trim Out to Playhead", category: "Shortcut", shortcut: "W", action: () => runBundledShortcut('Trim Out to playhead.jsxbin') },
  { type: "command", name: "Go to Next Marker Boundary", category: "Navigation", shortcut: "X", action: () => goToMarkerBoundary(1) },
  { type: "command", name: "Go to Previous Marker Boundary", category: "Navigation", shortcut: "Alt+X", action: () => goToMarkerBoundary(-1) },
  { type: "command", name: "Toggle Edit / Keyframe View", category: "View", shortcut: "Option/Alt+`", action: toggleTimelineMode },
  { type: "command", name: "Composition Flow", category: "Navigation", shortcut: "Tab", action: toggleFlowChart },
  { type: "command", name: "Reveal Keyframes", category: "View", shortcut: "U", action: toggleSelectedKeyframeExpansion },
  { type: "command", name: "Expand Animated Keyframe Properties", category: "View", shortcut: "", action: expandAnimatedKeyframeProperties },
  { type: "command", name: "Collapse Keyframe Properties", category: "View", shortcut: "", action: collapseAllKeyframeProperties },
  { type: "command", name: "Reveal Transform Properties", category: "View", shortcut: "T", action: revealSelectedTransformProperties },
  { type: "command", name: "Ease Editor", category: "Keyframes", shortcut: "E", visibleWhen: "selectedKeyframes", action: () => openSubpanelByKey("ease") },
  { type: "command", name: "Apply Easy Ease", category: "Keyframes", shortcut: "Shift+E", visibleWhen: "selectedKeyframes", action: applyEasyEaseDirect },
  { type: "command", name: "Mask Control", category: "Masks", shortcut: "F", action: () => openSubpanelByKey("mask") },
  { type: "command", name: "Effects Control", category: "Effects", shortcut: "", action: () => openSubpanelByKey("effects") },
  { type: "command", name: "Shape Control", category: "Shapes", shortcut: "", action: () => openSubpanelByKey("shapes") },
  { type: "command", name: "Layer Menu", category: "Layers", shortcut: "", action: () => openSubpanelByKey("layer-menu") },
  { type: "command", name: "Focus Selected Layers", category: "View", shortcut: "Shift+F", action: toggleKeyframeFocusMode },
  { type: "command", name: "Layer Styles...", category: "Layer Styles", shortcut: "S", action: () => openSubpanelByKey("styles") },
  { type: "command", name: "Rename Composition...", category: "Composition", shortcut: "", action: promptRenameComp },
  { type: "command", name: "Set Composition Length", category: "Composition", shortcut: "", action: promptCompDuration },
  { type: "command", name: "Composition Tools", category: "Composition", shortcut: "C", action: () => openSubpanelByKey("composition") },
  { type: "command", name: "Anchor Point Master", category: "Anchor", shortcut: "A", action: () => openSubpanelByKey("anchor") },
  { type: "command", name: "Center Anchor Point", category: "Anchor", shortcut: "Shift+A", action: centerSelectedAnchorPoints },
  { type: "command", name: "Layer Selection & Filters", category: "Layers", shortcut: "Shift+X", action: () => openSubpanelByKey("filter") },
  { type: "command", name: "Stagger & Layer Order", category: "Layers", shortcut: "", action: () => openSubpanelByKey("timing-order") },
  { type: "command", name: "Flip Layer Order", category: "Layers", shortcut: "", action: () => moveSelectedLayersInStack("reverse") },
  { type: "command", name: "Duplicate Selected Layers", category: "Edit", shortcut: "Ctrl+D", action: duplicateSelectedLayers },
  { type: "command", name: "Split Selected Layers", category: "Edit", shortcut: "3", action: splitSelectedLayersAtPlayhead },
  { type: "command", name: "Delete Selected Layers", category: "Edit", shortcut: "Delete", action: deleteSelectedLayers },
  { type: "command", name: "Add Layer", category: "Layers", children: [
    { name: "Add Null Layer", category: "Layers", action: () => createLayerFromFxConsole("null") },
    { name: "Add Shape Layer", category: "Layers", action: () => createLayerFromFxConsole("shape") },
    { name: "Add Text Layer", category: "Layers", action: () => createLayerFromFxConsole("text") },
    { name: "Add Box Text Layer", category: "Layers", action: () => createLayerFromFxConsole("boxtext") },
    { name: "Add Solid Layer", category: "Layers", action: () => createLayerFromFxConsole("solid") },
    { name: "Add Adjustment Layer", category: "Layers", action: () => createLayerFromFxConsole("adjustment") },
    { name: "Add Camera Layer", category: "Layers", action: () => createLayerFromFxConsole("camera") },
    { name: "Add Light Layer", category: "Layers", action: () => createLayerFromFxConsole("light") }
  ] },
  { type: "command", name: "Snap Layers to Playhead In Point", category: "Snap", shortcut: "", action: () => runLayerTimingAction("snap", { anchor: "in" }) },
  { type: "command", name: "Snap Layers to Playhead Out Point", category: "Snap", shortcut: "", action: () => runLayerTimingAction("snap", { anchor: "out" }) },
  { type: "command", name: "Pull Layer Group to Playhead In Point", category: "Pull", shortcut: "", action: () => runLayerTimingAction("pull", { anchor: "in" }) },
  { type: "command", name: "Pull Layer Group to Playhead Out Point", category: "Pull", shortcut: "", action: () => runLayerTimingAction("pull", { anchor: "out" }) },
  { type: "command", name: "Snap Keyframes to Playhead First Key", category: "Snap", shortcut: "", action: () => runKeyframeTimingAction("snap", { anchor: "first" }) },
  { type: "command", name: "Snap Keyframes to Playhead Last Key", category: "Snap", shortcut: "", action: () => runKeyframeTimingAction("snap", { anchor: "last" }) },
  { type: "command", name: "Snap Keyframes to Layer In Point", category: "Snap", shortcut: "", action: () => runKeyframeTimingAction("snap", { anchor: "layerIn" }) },
  { type: "command", name: "Snap Keyframes to Layer Out Point", category: "Snap", shortcut: "", action: () => runKeyframeTimingAction("snap", { anchor: "layerOut" }) },
  { type: "command", name: "Pull Selected Keyframes to Playhead First Key", category: "Pull", shortcut: "", visibleWhen: "selectedKeyframes", action: () => runKeyframeTimingAction("pull", { anchor: "first" }) },
  { type: "command", name: "Pull Selected Keyframes to Playhead Last Key", category: "Pull", shortcut: "", visibleWhen: "selectedKeyframes", action: () => runKeyframeTimingAction("pull", { anchor: "last" }) },
  { type: "command", name: "Stagger Selected Keyframes 5 Frames Ascending", category: "Stagger", shortcut: "", visibleWhen: "selectedKeyframes", action: () => runKeyframeTimingAction("stagger", { direction: "asc", amount: 5, unit: "frames", group: 1 }) },
  { type: "command", name: "Stagger Selected Keyframes 5 Frames Descending", category: "Stagger", shortcut: "", visibleWhen: "selectedKeyframes", action: () => runKeyframeTimingAction("stagger", { direction: "desc", amount: 5, unit: "frames", group: 1 }) },
  { type: "command", name: "Stagger Selected Keyframes 5 Frames Random", category: "Stagger", shortcut: "", visibleWhen: "selectedKeyframes", action: () => runKeyframeTimingAction("stagger", { direction: "random", amount: 5, unit: "frames", group: 1 }) },
  { type: "command", name: "Zoom In Timeline", category: "View", shortcut: "2", action: () => zoomTimeline(1.22) },
  { type: "command", name: "Zoom Out Timeline", category: "View", shortcut: "1", action: () => zoomTimeline(0.82) },
  { type: "command", name: "Play / Pause", category: "Playback", shortcut: "Space", action: togglePlay }
];
...
const TNT_V3_COMMANDS = [
  ...
  { name: "Rename Composition...", category: "Composition", action: promptRenameComp },
  ...
  { name: "Mask Control", category: "Masks", action: () => openSubpanelByKey("mask") },
  { name: "Effects Control", category: "Effects", action: () => openSubpanelByKey("effects") },
  { name: "Shape Control", category: "Shapes", action: () => openSubpanelByKey("shapes") },
  { name: "Layer Menu", category: "Layers", action: () => openSubpanelByKey("layer-menu") },
  { name: "Layer Styles...", category: "Layer Styles", action: () => openSubpanelByKey("styles") },
